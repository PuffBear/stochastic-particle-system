...
minimum in shared-arm angular error at $\Lmax$ (adjacent paired
$t$-tests: $t(31){\geq}3.40$, $p{<}0.001$ at both speeds), and inter-agent angular dispersion
...
($L{=}10$ at slow, $L{=}3$ at mid), confirmed by adjacent paired
$t$-tests (slow: $t(31){\in}\{8.40,\,3.40\}$, both $p{<}0.001$;
mid: $t(31){=}5.30$, $p{<}0.001$; $B{=}10{,}000$ bootstrap CIs all
exclude zero).  Beyond $\Lmax$ the shared
