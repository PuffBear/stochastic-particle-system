...
beneficial.  Instrumented runs directly show the mechanism's two
directional signatures (U-shaped shared-arm error minimised at
$\Lmax$; inter-agent angular dispersion zero for the shared arm,
non-zero for the independent arm).  The coordination benefit landscape under rotation is
