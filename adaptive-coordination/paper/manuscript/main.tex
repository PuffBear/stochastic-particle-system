...
third condition shows complex behaviour discussed in the paper. A pre-experiment analytical
...
\begin{enumerate}
  ...
  rotation speeds ($\Tcorr \in \{33, 10\}$ clean interior anchors,
  plus boundary very\_slow at $\Tcorr{=}67$; a supplementary
  $\Tcorr{=}20$ condition shows anomalous breadth without a sharp
  crossover and is discussed separately).
